...
exports.submitQuery = async (req, res) => {
    try {
      ...
      // In userSupportController.js - submitQuery()
...
if (emailResult) {
    ...
    // ✅ IMPORTANT: Mark this confirmation email as processed immediately
    if (emailResult.gmailApiMessageId) {
        await supportTicketService.markEmailProcessed(emailResult.gmailApiMessageId, ticket.id);
        logger.info(`✅ Marked confirmation email as processed: ${emailResult.gmailApiMessageId}`);
    }
}
