...
//      * (also used by admin via POST /api/admin/working-hours?appointment_type=...)
//      */
//     async getWorkingHours(req, res, next) {
//         try {
//             const type = (req.query.type || '').trim() || null;
//             const hospitalId = getHospitalId(req) || null; // null means global/public
...
//      * POST /api/slots - Body: { date, type } (public)
//      * POST /api/admin/ - Body: { date, type } (admin, filtered by hospital)
//      * GET /api/slots?date=2026-06-03&type=consultation
//      * 
//      * ✅ FIX #4: Removed spaces from time strings
//      */
...
//             const hospitalId = getHospitalId(req) || null; // null for public, set for admin
...
//      * POST /api/slots/check - Body: { date, time, type }
//      * GET /api/slots/check?date=2026-06-03&time=2:30 PM&type=consultation
//      */
...
//             // ✅ FIX #4: Remove spaces from time string for consistency
...
//      * GET /api/slots/available-days?type=consultation
//      */
