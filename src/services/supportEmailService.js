...
async startWatch() {
    ...
    // ✅ Build ALL header lines first — nothing after this array gets a
    // blank-line separator until every header is in place.
    const emailLines = [
    ...
    parseEmail(gmailMessage) {
        ...
        if (gmailMessage.payload.parts) {
            ...
            plainText = Buffer.from(gmailMessage.payload.body.data, 'base64').toString('utf-8');
        }
